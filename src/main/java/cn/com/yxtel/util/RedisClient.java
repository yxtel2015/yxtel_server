...
public class RedisClient {
    ...
    private void initialPool()
    {
        ...
        jedisPool = new JedisPool(config,"192.168.12.194",6379);
    }
    ...
    private void initialShardedPool()
    {
        ...
        shards.add(new JedisShardInfo("192.168.12.194", 6379, ""));
    ...
    private void SetOperate()
    {
        ...
        System.out.println("向sets集合中加入元素element004："+jedis.sadd("sets", "element006"));
